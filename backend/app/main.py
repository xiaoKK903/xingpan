...
from app.routers import users, conversations, messages, chat, astro, geo, charts, reports, synastry, ai_interpretation, daily_horoscope, synastry_analysis, transit, social_icebreaker, group_matrix, life_script, workbench, plaza, social_plaza, boss_battle, energy_weather, star_resonance, advanced_prediction, exclusive_items, element_quest, phase_connect, network_chain, synastry_enhanced, private_chat, photocard, checkin, invite, activity, daily_cp_match, pk_system, past_life, topic_challenge, story_card
from app.routers import vip, gifts, report_shop, payment, growth_tasks, leaderboards, ad_free, time_capsule
...
app.include_router(social_plaza.router, prefix="/api/social-plaza", tags=["社交广场"])
...
app.include_router(invite.router, prefix="/api/invite", tags=["邀请好友系统"])
app.include_router(activity.router, prefix="/api/activity", tags=["活动系统"])
app.include_router(growth_tasks.router, prefix="/api/growth-tasks", tags=["成长任务"])
app.include_router(leaderboards.router, prefix="/api/leaderboards", tags=["荣誉排行榜"])
app.include_router(ad_free.router, prefix="/api/ad-free", tags=["去广告权益"])
app.include_router(daily_cp_match.router, prefix="/api/daily-cp-match", tags=["每日CP匹配"])
app.include_router(time_capsule.router, prefix="/api", tags=["时间胶囊"])
app.include_router(pk_system.router, prefix="/api/pk", tags=["星盘能量PK"])
app.include_router(past_life.router, prefix="/api/past-life", tags=["前世故事玩法"])
app.include_router(topic_challenge.router, prefix="/api/topic-challenge", tags=["话题挑战"])
app.include_router(story_card.router, prefix="/api/story-card", tags=["故事卡与故事墙"])
